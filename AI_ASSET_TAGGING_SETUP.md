...
## Step 6: Upload your own asset to AEM

Login to AEM https://author-p106442-e1666219.adobeaemcloud.com/ui#/aem/assets.html/content/dam/bootcamp?appId=aemshell

Upload your own asset to `/content/dam/bootcamp`

![alt text](images/Xnip2025-11-27_14-03-39.jpg)

![alt text](images/Xnip2025-11-27_14-04-07.jpg)

Take note of the asset path for the image you just uploaded e.g. `/content/dam/bootcamp/valtteri-bottas.jpg`

## Step 7: Test the AI Asset Tagging Action

### 7.1 Test with postman

Update `assetPath` below to be the asset path from the previous step
...
curl --location 'https://391665-123orchidyak-stage.adobeioruntime.net/api/v1/web/brendanbc2app/ai-asset-tagging' \
...
### Login to AEM JCR to see updated metadata

https://author-p106442-e1666219.adobeaemcloud.com/crx/de/index.jsp#/content/dam/bootcamp/valtteri-bottas.jpg/jcr%3Acontent/metadata 

ensure you replace the /content path with your path from above

you will see metadata props updated e.g. aigenkeywords. 

These were generated by Azure Open AI GPT 4.1.

![alt text](images/Xnip2025-11-27_14-08-00.jpg)
